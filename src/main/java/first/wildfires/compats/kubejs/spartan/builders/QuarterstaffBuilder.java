...
public class QuarterstaffBuilder extends SpartanWeaponBuilder {

    public QuarterstaffBuilder(ResourceLocation i) {
        super(i);
    }

    @Override
    public Item createObject() {
        var item = WeaponFactory.QUARTERSTAFF.create(material, new Item.Properties());
