...
public class JavelinBuilder extends SpartanWeaponBuilder {

    public int maxAmmo = 4;

    public JavelinBuilder(ResourceLocation i) {
        super(i);
    }

    @Override
    public Item createObject() {
        var item = WeaponFactory.JAVELIN.create(material, new Item.Properties());
    ...
    public JavelinBuilder setAmmo(int number) {
        maxAmmo = number;
