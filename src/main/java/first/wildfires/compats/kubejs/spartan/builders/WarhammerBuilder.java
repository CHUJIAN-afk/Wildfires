...
public class WarhammerBuilder extends SpartanWeaponBuilder {

    public WarhammerBuilder(ResourceLocation i) {
        super(i);
    }

    @Override
    public Item createObject() {
        var item = WeaponFactory.WARHAMMER.create(material, new Item.Properties());
