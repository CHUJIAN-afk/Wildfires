...
public class SaberBuilder extends SpartanWeaponBuilder {

    public SaberBuilder(ResourceLocation i) {
        super(i);
    }

    @Override
    public Item createObject() {
        var item = WeaponFactory.SABER.create(material, new Item.Properties());
