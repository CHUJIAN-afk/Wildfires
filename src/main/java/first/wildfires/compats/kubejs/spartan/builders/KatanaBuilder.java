...
public class KatanaBuilder extends SpartanWeaponBuilder {

    public KatanaBuilder(ResourceLocation i) {
        super(i);
    }

    @Override
    public Item createObject() {
        var item = WeaponFactory.KATANA.create(material, new Item.Properties());
