...
public class HalberdBuilder extends SpartanWeaponBuilder {

    public HalberdBuilder(ResourceLocation i) {
        super(i);
    }

    @Override
    public Item createObject() {
        var item = WeaponFactory.HALBERD.create(material, new Item.Properties());
